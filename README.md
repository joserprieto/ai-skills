...
| ---------------------------------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [cendoj-toolkit](skills/cendoj-toolkit/SKILL.md)                             | `0.1.0` | Use when the user needs to search and download court decisions from CENDOJ (Centro de Documentación Judicial del Consejo General del Poder Judicial), the Spanish official judicial database.                                                                        |
...
| [drawio-uml-shapes](skills/drawio-uml-shapes/SKILL.md)                       | `0.7.0` | Use when generating or editing draw.io diagrams with UML shapes.                                                                                                                                                                                                     |
...
| [repo-kickstart](skills/repo-kickstart/SKILL.md)                             | `0.7.3` | Use when creating a new repository, initializing a project from scratch, or setting up OSS infrastructure (CI/CD, linting, releases, docs).                                                                                                                          |
