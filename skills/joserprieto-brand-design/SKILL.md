...
description: >-
  ...
  presentations, documents, design systems, or UI components. Also use when user says
  "joserprieto colors", "joserprieto brand", "jrp brand", "brand tokens", "jrp diagram",
  "jrp styling", "personal brand", "brand guidelines", "jrp design system", or
  "jrp-ds tokens".
license: MIT
metadata:
...
Complete joserprieto personal brand design system as portable tokens. Covers all color
palettes (OKHSL-generated), typography, spacing, radius, diagram conventions, logo usage,
code syntax highlighting, and chart palette.
...
All palettes generated with the OKHSL color system for perceptual uniformity. Use the
EXACT hex values below. 11 stops each (50–950).
...
**SIM card asymmetric pattern** (brand signature element):
Ratio: 3:4 for normal corners, 5:6 for cut corner. Used in branded UI elements.
...
CSS pattern: `border-radius: {default-v} {default-v} {default-v} {cut-v} / {default-h} {default-h} {cut-h} {default-h}`
...
Standardized color mapping for all diagram elements. Apply to draw.io, Mermaid, D2,
or any SVG diagram.
...
For D2 diagrams, apply these color overrides. Primary elements use B5 (`#3d5a3d`),
neutral containers use N1-N2, and text uses N7 (`#141a14`).
