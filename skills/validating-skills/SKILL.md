...
description: >-
  Use when validating, auditing, or reviewing Agent Skills for compliance with
  the agentskills.io specification. Also use when creating new skills to verify
  format requirements, when asked to "validate skill", "check skill", "audit
  skill", "lint skill", or "review skill compliance".
metadata:
...
Validates Agent Skills against the [Agent Skills specification](https://github.com/agentskills/agentskills).
...
1. **R5.1** — Reduce SKILL.md body from 658 to ≤ 500 lines. Move [specific content]
   to a reference file.
